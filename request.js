                ...
                <div class="col-md-8">
                    ...
                    <div>
                        ...
                        <li class="list-group-item borderzero">
                            ...
                            <span class="ml-1" id="company">${data.email}</span>
                        </li>
                    </div>
                </div>
        `
...
// 1 - aratılan kullanıcıların kullanıcı adları local storage'a eklenecek (son 5 adet gösterilecek)
// 2 - son kullanıcılar kısmına veriler local storage'dan getirtilecek

// users = []
// users = ["canertsz", "cemaltuysuz"]